...
public class SpontanAdapter extends RecyclerView.Adapter<SpontanAdapter.MyViewHolder> {
    ...
    public SpontanAdapter(List<Spontan> spontans) {
        this.spontans = spontans;
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
       final Spontan spontan= this.spontans.get(position);
    ...
    public List<Spontan> getActiveSpontans(){
        return this.spontans;
    }

    public void setSpontans(List<Spontan> spontans) {
        this.spontans = spontans;
    }
}
