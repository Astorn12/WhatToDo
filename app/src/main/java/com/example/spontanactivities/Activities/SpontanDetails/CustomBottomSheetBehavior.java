...
public class CustomBottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    class NamelessClass_1 extends Callback {
        ...
        public boolean tryCaptureView(@NonNull View child, int pointerId) {
            if (state == 1) {
                ...
                if (state == 3 && activePointerId == pointerId) {
                    View scroll = (View) nestedScrollingChildRef.get();
        ...
        public int getViewVerticalDragRange(@NonNull View child) {
            return hideable ? parentHeight : collapsedOffset;
        }
    }
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (this.state == 3) {
            ...
            ViewCompat.offsetTopAndBottom(child, 1387);
    ...
    public final void setPeekHeight(int peekHeight) {
        ...
        if (layout && this.state == 4 && this.viewRef != null) {
            View view = (View)this.viewRef.get();//ZMIANA
            if (view != null) {
                view.requestLayout();
            }
        }
    ...
    public void setBottomSheetCallback(com.google.android.material.bottomsheet.BottomSheetBehavior.BottomSheetCallback callback) {
    ...
    public final void setState(final int state) {
        if (state != this.state) {
            if (this.viewRef == null) {
                ...
                final View child = (View)this.viewRef.get();//ZMIANA
                if (child != null) {
    ...
    @SuppressLint("WrongConstant")//ZMIANA
